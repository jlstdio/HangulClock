 ...
 */
public class bigsizesmall extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds)
    {
        ...
        for(int i = 0 ; i < N ; i++)
        {
            ...
            RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.bigsizesmall);//new_app_widget의 objects들의 값을 변경하기위함입니다
